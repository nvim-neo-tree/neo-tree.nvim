    ...
    directory = {
      ...
      { "current_filter" },
      {
        ...
        content = {
          ...
          { "file_size", zindex = 20, align = "right", required_width = 60 },
          --{ "type", zindex = 20, align = "right", required_width = 55 },
          { "last_modified", zindex = 20, align = "right", required_width = 86 },
          --{ "created", zindex = 20, align = "right", required_width = 100 },
        },
      },
    },
    file = {
