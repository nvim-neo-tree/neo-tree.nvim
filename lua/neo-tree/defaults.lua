    ...
    directory = {
      ...
      { "current_filter" },
      {
        ...
        content = {
          ...
          { "file_size", zindex = 20, align = "right", required_width = 55 },
          --{ "type", zindex = 20, align = "right", required_width = 55 },
          { "file_time", stat="mtime", zindex = 20, align = "right", required_width = 78 },
          { "file_time", stat="birthtime", zindex = 20, align = "right", required_width = 100 },
        },
      },
    },
    file = {
