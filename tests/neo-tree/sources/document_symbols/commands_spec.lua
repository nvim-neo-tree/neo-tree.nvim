...
describe("document_symbols commands", function()
  ...
  describe("preview_symbol", function()
  ...
  describe("follow_selection", function()
    it("should auto-preview when cursor moves in tree", function()
      ...
      -- Setup neo-tree with follow_selection enabled
    ...
    it("should not auto-preview when follow_selection is disabled", function()
      -- Create a test file
      local test_file = vim.fn.tempname() .. ".lua"
      local lines = {
        "-- Test file",
      ...
      -- Setup neo-tree with follow_selection disabled (default)
      require("neo-tree").setup({
        sources = { "document_symbols" },
        document_symbols = {
      ...
      assert.are.equal(
        initial_cursor[1],
        current_cursor[1],
        "Target window should NOT have scrolled when follow_selection is disabled"
      )
